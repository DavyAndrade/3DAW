                ...
                <?php if (count($alunos) > 0): ?>
                    <?php foreach ($alunos as $index => $aluno): ?>
                        <tr>
                            ...
                            <td>
                                <a href="modificarAluno.php?id=<?php echo $index; ?>">Editar</a> |
                                <a href="deletarAluno.php?id=<?php echo $index; ?>" onclick="return confirm('Tem certeza que deseja deletar esse aluno?')">Deletar</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
